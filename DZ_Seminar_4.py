...
# d =  int(input("Введите число знаков после запятой, для заданной точности числа Пи:\n"))
...
# with open('Python_Seminar_4/Polynomial.txt', 'w') as data:
#     data.write(list)
# with open('Python_Seminar_4/Polynomial2.txt', 'w') as data:
#     data.write(list)
...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("Python_Seminar_4/file_1.txt", create_str(koef1))
write_file("Python_Seminar_4/file_2.txt", create_str(koef2))

# нахождение суммы многочлена

with open('Python_Seminar_4/file_1.txt', 'r') as data:
    st1 = data.readlines()
with open('Python_Seminar_4/file_2.txt', 'r') as data:
    st2 = data.readlines()
...
write_file("Python_Seminar_4/file_res.txt", create_str(lst_new))
with open('Python_Seminar_4/file_res.txt', 'r') as data:
    st3 = data.readlines()
